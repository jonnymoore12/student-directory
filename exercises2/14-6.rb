...
def save_students
   ...
   puts "Please enter filename with extension or hit return to save to"
   puts "students.csv"
   filename = gets.chomp
   filename = "students.csv" if filename == ""
   # Here's the alternate file writing stuff
...
def load_students(filename = "students.csv")
   puts "Please enter the filename with extension or hit return to load"
   puts "from students.csv"
   filename = gets.chomp
   filename = "students.csv" if filename == ""
